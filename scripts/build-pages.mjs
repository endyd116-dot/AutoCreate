...
const TARGETS = [
  ...
  { dir: "public/ops", suffix: "AutoCreate 운영센터", scripts: ["/js/ui.js?v=29", "/js/ops.js?v=3", "/js/mock-ops.js?v=1"], back: ["tenant.html", "ticket.html", "cs-faq.html", "password.html", "company.html"], fallback: "/ops/", fallbacks: { "company.html": "/ops/plans.html", "tenant.html": "/ops/tenants.html", "ticket.html": "/ops/cs.html", "cs-faq.html": "/ops/cs.html" }, manifest: false, robots: true, titleInBar: true, bodyClass: "ops" }, // 운영센터는 제목 유지(§13.0b «운영 콘솔 예외» · 밀도)
];
