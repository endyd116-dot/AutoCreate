 ...
 *   🔴 ①②는 **켜기만 한다**(자동으로 끄지 않는다) — 운영자가 끈 것을 크론이 다시 켜면 손이 진다.
...
export const INTERNAL_KEY_RE = /^(verify|smoke|test|harness|demo|skip|r[0-9]|ac-?test|p1r[0-9]|live-?c[0-9])/i;
...
export function looksInternal(email: string | null | undefined, key: string | null | undefined): boolean {
