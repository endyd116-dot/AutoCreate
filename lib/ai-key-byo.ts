 ...
 *   🔎 출처: AC 신규(계약 P1R8-B §4.4 · 생성 커밋 `f7e94ca` 2026-09-15) — AM 원본 없음(`../AutoMarketing/lib/` 에 같은 이름 없음 · 2026-09-16 확인).
 *     AM 에 `ai-key.ts` 가 있지만 그건 **우리 키 로테이션**이고 AC 에도 같은 이름으로 따로 있다(§3.3). 여기는 **고객 키**다.
 *
 *   ══ 🔴 여기는 «고르는 자리»가 아니다 ══
